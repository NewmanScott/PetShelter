...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<h2>Details about {{pet.name}}</h2>\n<a class=\"btn btn-primary\" role=\"button\" [routerLink]=\"['/']\">Home</a>\n<h4>Pet type:</h4>\n<p>{{pet.type}}</p>\n<h4>Description</h4>\n<p>{{pet.description}}</p>\n<h4>Skills</h4>\n<ul>\n    <li *ngIf=\"pet.skill1 != undefined\">{{pet.skill1}}</li>\n    <li *ngIf=\"pet.skill2 != undefined\">{{pet.skill2}}</li>\n    <li *ngIf=\"pet.skill3 != undefined\">{{pet.skill3}}</li>\n</ul>\n<h4>Likes</h4>\n<p>{{pet.likes}}</p>\n<a class=\"btn btn-primary\" role=\"button\" href=\"#!\">Like</a> | \n<a class=\"btn btn-primary\" role=\"button\" href=\"#!\" (click)=\"delete(pet._id)\">Adopt</a>");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<h2>Edit this pet</h2>\n\n<form (submit)=\"updatePet2(pet._id)\">\n        <div> \n                <label>Pet name:</label>\n            \n                <input type=\"text\" name=\"pet.name\" [(ngModel)]=\"pet.name\">\n                <span *ngIf=\"errors.name\">{{errors.name.message}}</span>\n            </div>\n            <div>\n                    <label>Pet type:</label>\n                    <input type=\"text\" name=\"pet.type\" [(ngModel)] = \"pet.type\">\n                    <span *ngIf=\"errors.type\">{{errors.type.message}}</span>\n            </div>\n            <div>\n                    <label>Description:</label>\n                    <input type=\"text\" name=\"pet.description\" [(ngModel)]=\"pet.description\">\n                    <span *ngIf=\"errors.description\">{{errors.description.message}}</span>\n            </div>\n            <div>\n                <label>Skill 1:</label>\n                <input type=\"text\" name=\"pet.skill1\" [(ngModel)]=\"pet.skill1\">\n                <span *ngIf=\"errorsskill1\">{{errors.skill1}}</span>\n                <label>Skill 2:</label>\n                <input type=\"text\" name=\"pet.skill2\" [(ngModel)]=\"pet.skill2\">\n                <span *ngIf=\"errors.skill2\">{{errors.skill2}}</span>\n                <label>Skill 3:</label>\n                <input type=\"text\" name=\"pet.skill3\" [(ngModel)]=\"pet.skill3\">\n                <span *ngIf=\"errors.skill3\">{{errors.skill3}}</span>\n            </div>\n            <input class=\"btn btn-primary\" type=\"submit\" value=\"Update\"> | \n            <button type=\"button\" class=\"btn btn-primary\" [routerLink]=\"['/']\">Cancel</button>\n</form>");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<h2>These pets are looking for a home!</h2>\n\n<a class=\"btn btn-primary\" role=\"button\" [routerLink]=\"['/new']\">Add a pet to the shelter</a>\n<br>\n\n\n<table class=\"table\">\n        <thead>\n          <tr>\n            <th scope=\"col\">Name</th>\n            <th scope=\"col\">Type</th>\n            <th scope=\"col\">Actions</th>\n          </tr>\n        </thead>\n        <tbody>\n          <tr *ngFor=\"let pet of pets\">\n           <td>{{pet.name}}</td>\n           <td>{{pet.type}}</td>\n           <td><a class=\"btn btn-primary\" role=\"button\" [routerLink]=\"['/pets/', pet._id]\">Details</a> | <a class=\"btn btn-primary\" role=\"button\" [routerLink]=\"['/pets/', pet._id, 'edit']\">Edit</a></td>\n          </tr>\n        </tbody>\n      </table>");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<h2>Know of a pet needing a home?</h2>\n\n<form (submit)=\"createPet()\">\n    <div> \n        <label>Pet name:</label>\n    \n        <input type=\"text\" name=\"pet.name\" [(ngModel)]=\"pet.name\">\n        <span *ngIf=\"errors.name\">{{errors.name.message}}</span>\n    </div>\n    <div>\n            <label>Pet type:</label>\n            <input type=\"text\" name=\"pet.type\" [(ngModel)] = \"pet.type\">\n            <span *ngIf=\"errors.type\">{{errors.type.message}}</span>\n    </div>\n    <div>\n            <label>Description:</label>\n            <input type=\"text\" name=\"pet.description\" [(ngModel)]=\"pet.description\">\n            <span *ngIf=\"errors.description\">{{errors.description.message}}</span>\n    </div>\n    <div>\n        <label>Skill 1:</label>\n        <input type=\"text\" name=\"pet.skill1\" [(ngModel)]=\"pet.skill1\">\n        <span *ngIf=\"errorsskill1\">{{errors.skill1}}</span>\n        <label>Skill 2:</label>\n        <input type=\"text\" name=\"pet.skill2\" [(ngModel)]=\"pet.skill2\">\n        <span *ngIf=\"errors.skill2\">{{errors.skill2}}</span>\n        <label>Skill 3:</label>\n        <input type=\"text\" name=\"pet.skill3\" [(ngModel)]=\"pet.skill3\">\n        <span *ngIf=\"errors.skill3\">{{errors.skill3}}</span>\n    </div>\n   \n    \n    \n    <input class=\"btn btn-primary\" type=\"submit\" value=\"Create a pet\"> | \n    <button type=\"button\" class=\"btn btn-primary\" [routerLink]=\"['/']\">Cancel</button>\n</form>");
...
let DetailsComponent = class DetailsComponent {
    ...
    ngOnInit() {
        this._route.params.subscribe((params) => {
            ...
            const petObservable = this._httpService.getOnePet(params['_id']);
            petObservable.subscribe(res => this.pet = res);
        });
    }
    delete(_id) {
        console.log;
        const observable = this._httpService.delete(_id);
...
let EditComponent = class EditComponent {
    ...
    updatePet2(_id) {
        ...
        const observable = this._httpService.updatePet(_id, this.pet);
...
let ListComponent = class ListComponent {
    ...
    ngOnInit() {
        const petObservable = this._http.getPets();
...
let NewComponent = class NewComponent {
    ...
    createPet() {
        const petObservable = this._http.createPet1(this.pet);
        petObservable.subscribe(res => {
            if (res.errors) {
                this.errors = res.errors;
            }
...
module.exports = __webpack_require__(/*! C:\Users\Newmy\Desktop\BeltExamMEAN\client\src\main.ts */"./src/main.ts");
